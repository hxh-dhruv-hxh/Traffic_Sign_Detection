...
class TFAnnotation:
    ...
    def __init__(self):
        ...
        # Initializing the bounding boxes + label lists
        self.xMins = []
        self.xMaxs = []
        self.yMins = []
        self.yMaxs = []
        ...
        # Initializing the additional variables, including the image itself, spatial dimensions, encoding and filename
        self.image = None
        self.width = None
        self.height = None
        self.encoding = None
    ...
    def build(self):
        ...
        # Encoding the attributes using their respective tensorflow encoding function
        ...
        # Constructing the tensorflow compactible data dictionary
        data = {"image/height":h,
                "image/width":w,
