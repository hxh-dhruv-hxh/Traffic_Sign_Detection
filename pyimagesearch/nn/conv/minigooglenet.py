...
class MiniGoogLenet:
    ...
    def inception_module(x, numK1x1, numK3x3, chanDim):
        # Defining two Conv modules that concatenates across the chanDim
    ...
    @staticmethod
    def downsample_sample(x, K, chanDim):
        # Defining the ConV module and POOL, then concatenate across the channel dimensions
